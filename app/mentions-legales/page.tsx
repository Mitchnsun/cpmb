  ...
  return (
    <>
      ...
      <section className="max-w-site mx-auto px-6 pt-16 pb-20">
        <article className="flex flex-col justify-around gap-8 lg:flex-row lg:gap-20">
          <div className="flex-1">
            ...
            <p className="text-lg">
              ...
              internationale sur le droit d&apos;auteur et la propriété intellectuelle. Les droits de l&apos;auteur de
              ce site sont réservés pour toute forme d&apos;utilisation. En particulier, la reproduction des éléments
              graphiques du site, le téléchargement complet du site pour son enregistrement sur un support de diffusion,
              ainsi que toute utilisation des visuels et textes qu&apos;il contient autre que la consultation
              individuelle et privée sont interdites sauf autorisation expresse du directeur de la publication.
            </p>
          </div>

          <div className="flex-1">
            <h2 className="font-display mb-4 text-3xl font-semibold">Données personnelles</h2>
            ...
            <p className="text-lg">
              ...
              limitation du traitement et d&apos;opposition concernant vos données personnelles. Pour exercer ces
