...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      ...
      <button
        type="submit"
        className="w-full rounded-md bg-sky-700 px-4 py-2 font-medium text-white transition-colors hover:bg-sky-600 focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:outline-none"
      >
        Envoyer le message
      </button>
